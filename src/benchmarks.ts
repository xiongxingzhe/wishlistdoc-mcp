import { GenreBenchmarkInfo } from './types.js';

export const GENRE_BENCHMARKS: Record<string, GenreBenchmarkInfo> = {
  rpg: {
    genre: 'RPG / Strategy (High Depth)',
    description:
      'Deep system-driven games including turn-based RPGs, grand strategy, deckbuilders, and tactical simulations. Highly sticky audiences with strong pre-order/launch willingness.',
  ...
  action: {
    ...
    description:
      'Fast-paced mechanical action games, twin-stick shooters, side-scrolling platformers, and action roguelites. Driven by visual responsiveness and dynamic combat loops.',
  ...
  simulation: {
    ...
    description:
      'Colony sims, factory automation, farming simulators, and tycoon games. Exceptional long-tail sales curve with steady post-launch update momentum.',
  ...
  horror: {
    ...
    description:
      'Psychological horror, jump-scare survival, and found-footage exploration. Highly viral among content creators with intense launch-window spikes.',
  ...
  casual: {
    ...
    description:
      'Cozy games, logic puzzle solvers, visual novels, and short narrative experiences. Broader audience but higher price sensitivity.',
...
export function getGenreBenchmark(query?: string): GenreBenchmarkInfo | Record<string, GenreBenchmarkInfo> {
