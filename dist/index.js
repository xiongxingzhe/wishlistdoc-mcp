        ...
        tools: [
            {
                ...
                description: 'Audit a Steam game store page health score (0-100), letter grade (S/A/B/C/D/F), 6 algorithmic dimensions (tags, localization, pricing resistance, demo loop, visual assets, short description), and prioritized actionable prescriptions. Powered by WishlistDoc (https://wishlistdoc.com).',
                inputSchema: {
                    type: 'object',
                    properties: {
                        appid: {
            ...
            },
            {
                ...
                description: 'Forecast Steam first-week unit sales and first-year gross revenue across P10 (pessimistic floor), P50 (median benchmark), and P90 (breakout ceiling) confidence tiers. Powered by WishlistDoc empirical game discovery models.',
                inputSchema: {
                    type: 'object',
                    properties: {
                        appid: {
                        ...
                        wishlists: {
                            type: 'number',
                            description: 'Optional target or current pre-launch wishlist count. If omitted, an empirical estimate based on community size or median indie benchmark will be used.',
                        },
                        customPriceUSD: {
                            type: 'number',
                            description: 'Optional simulation price in USD (e.g. 19.99). Overrides the store price or default placeholder.',
                        },
                    },
                    required: ['appid'],
                },
            },
            {
                ...
                description: 'Retrieve Steam industry launch conversion benchmarks, Year-1 revenue multipliers, and 270-day wishlist decay curves for specific game genres (RPG, Action, Simulation, Horror, Casual, or all).',
                inputSchema: {
                    type: 'object',
                    properties: {
                        genre: {
                            type: 'string',
                            description: 'Genre name to query (e.g. "rpg", "action", "simulation", "horror", "casual", or "all").',
                        },
                    },
                },
            },
